...
class rrr_vector<31, t_rac, t_k, t_hybrid>
{
        static_assert(t_k > 1, "rrr_vector: t_k must be > 0.");
    public:
        static const uint16_t t_bs = 31;
        static const bool is_hybrid = t_hybrid != 31;
        ...
        binomial31<is_hybrid, t_hybrid> bi_type;
    private:
...
class rank_support_rrr<t_b, 31, t_rac, t_k, t_hybrid>
{
...
template<uint8_t t_b, class t_rac, uint16_t t_k, uint16_t t_hybrid>
class select_support_rrr<t_b, 31, t_rac, t_k, t_hybrid>
{
